...
/*
    This was a test similar to PicoServoTest but where
    we were testing changing the speed of the motor using
    two buttons instead of a loop as in experiment 4.
*/
